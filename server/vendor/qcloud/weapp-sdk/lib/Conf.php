...
class Conf {
    ...
    // 腾讯云 AppID
    private static $QcloudAppId = 1256301666;
    
    // 腾讯云 QcloudSecretId
    private static $QcloudSecretId = 'AKIDkJfngLazxgAQRDB25tSmriKhqkPpsxf8';

    // 腾讯云 QcloudSecretKey
    private static $QcloudSecretKey = 'KPGsFOIxNYUBdqoX1HI7h294kBNK2Vjj';
    
    // 微信消息通知 token
    private static $WxMessageToken = '8_V1bGodX3F18LakTfDtyLev6UwhyiIXBAx4hvev9URc53yEqAGV4GNNiWmpGca5Udv9mob3DnuQqvBhfzwMFciK2ascO2R9KvsCuVOwxLzEoknAERReuHzRUuDXbiupvuyny_RiV7NGRpSu5oARYbAHAULS';
